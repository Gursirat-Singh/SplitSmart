...
export const MainLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="min-h-screen bg-bg-canvas flex flex-col md:flex-row text-primary">
      {/* Mobile Header */}
      <header className="md:hidden flex items-center justify-between px-6 py-4 bg-primary-container text-white z-20 shadow-level-2">
        ...
        <button 
          ...
          className="p-1 text-on-primary-container hover:text-white focus:outline-none btn-transition"
        >
      ...
      {/* Sidebar Navigation */}
      <aside className={`
        fixed inset-y-0 left-0 z-30 w-[280px] bg-primary-container text-white px-6 py-8 flex flex-col justify-between
      ...
      `}>
        <div>
          ...
          <div className="hidden md:flex items-center gap-3 mb-10">
            ...
            <span className="font-semibold text-xl tracking-tight text-white">SplitSmart</span>
          </div>
        ...
        <div className="pt-6 border-t border-white/10 space-y-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-md bg-secondary flex items-center justify-center font-semibold text-white shadow-sm">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-md text-sm font-medium text-error hover:bg-error-light transition-all duration-200"
          >
